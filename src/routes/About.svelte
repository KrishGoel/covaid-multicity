    ...
    <div class="width-restriction">
       <div class="width-restriction">
          ...
          {#await fetchVolunteers}
            <p>Volunteers loading...</p>
            {:then data}
            <div class="row">
                {#each range(0,3,1) as i, index}
                <div class="col-3">
                    {#each data as volunteeer, j}
                    {#if j%3 == i}
                    <div class="card">
                        <div class="width-restriction">
                            <h3>{volunteeer.fields.name}</h3>
                            <p>{volunteeer.fields.role}</p>
                        </div>
                    </div>
                    {/if}
                    {/each}
